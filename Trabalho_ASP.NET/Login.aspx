...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="panel-heading">
      <h4>EFETUAR LOGIN <span class="glyphicon glyphicon-log-in" aria-hidden="true" /></h4>
  </div>
...
<p>
    <asp:CustomValidator ID="CustomValidator2" runat="server" ControlToValidate="txtSenha" ErrorMessage="Senha Incorreta" OnServerValidate="CustomValidator2_ServerValidate">Campo Obrigatório</asp:CustomValidator>
</p>
